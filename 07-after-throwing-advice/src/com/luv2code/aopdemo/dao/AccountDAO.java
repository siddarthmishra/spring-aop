...
public class AccountDAO {
	...
	public List<Account> findAccounts(boolean tripWire) throws Throwable {

		// for academic purpose ... simulate an exception
		if (tripWire)
			throw new Throwable("No soup for you!");
	...
	public void method1(boolean tripWire) throws Throwable {
		// for academic purpose ... simulate an exception
		if (tripWire)
